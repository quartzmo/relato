...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/vitalvu/Dropbox/code/vendor/react_examples/relato/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/vitalvu/Dropbox/code/vendor/react_examples/relato/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } (function () {
	...
	var _LoadingNotificationJsx = __webpack_require__(4);

	var _LoadingNotificationJsx2 = _interopRequireDefault(_LoadingNotificationJsx);

	var _sortProjectDataJs = __webpack_require__(161);

	var _sortProjectDataJs2 = _interopRequireDefault(_sortProjectDataJs);

	var _PaginationJsx = __webpack_require__(162);

	var _PaginationJsx2 = _interopRequireDefault(_PaginationJsx);

	var _SearchJsx = __webpack_require__(163);

	var _SearchJsx2 = _interopRequireDefault(_SearchJsx);

	var _DataTableJsx = __webpack_require__(164);

	var _DataTableJsx2 = _interopRequireDefault(_DataTableJsx);
	...
	var updateStats = function updateStats(projects) {
	  ...
	  document.getElementById('projectCount').innerHTML = (0, _numeral2['default'])(nodes).format('0,0');
	  document.getElementById('referenceCount').innerHTML = (0, _numeral2['default'])(edges).format('0,0');
	};

	var Relato = _react2['default'].createClass({
	  displayName: 'Relato',
	  ...
	  componentDidMount: function componentDidMount() {
	    var self = this;
	    loadCsv().then(transformToJs).then(function (projects) {
	      updateStats(projects);
	      var appState = self.getInitialState();
	      appState.projects = projects;
	      (0, _sortProjectDataJs2['default'])(appState);
	  ...
	  render: function render() {
	    if (this.state.projects.length === 0) {
	      return _react2['default'].createElement(_LoadingNotificationJsx2['default'], null);
	    }
	    var self = this;
	    ...
	    return _react2['default'].createElement('div', null, _react2['default'].createElement(_SearchJsx2['default'], { appState: this.state, refresher: refresher }), _react2['default'].createElement(_PaginationJsx2['default'], { appState: this.state, refresher: refresher }), _react2['default'].createElement(_DataTableJsx2['default'], { appState: this.state, refresher: refresher }));
	  }
	});

	_react2['default'].render(_react2['default'].createElement(Relato, null), document.getElementById('npm-data'));

	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/vitalvu/Dropbox/code/vendor/react_examples/relato/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Relato.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoadingNotification = _react2["default"].createClass({
	  displayName: "LoadingNotification",

	  render: function render() {
	    return _react2["default"].createElement("div", { className: "loading" }, _react2["default"].createElement("img", { src: "img/loading-animation.gif" }), _react2["default"].createElement("p", null, "Downloading statistics, please wait..."));
	  }
	});
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/vitalvu/Dropbox/code/vendor/react_examples/relato/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "LoadingNotification.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    var ReactHotAPI = require("/Users/vitalvu/Dropbox/code/vendor/react_examples/relato/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"),
	        RootInstanceProvider = require("/Users/vitalvu/Dropbox/code/vendor/react_examples/relato/node_modules/react-hot-loader/RootInstanceProvider.js"),
	  ...
	  var sortProjectData = function sortProjectData(appState) {
	  ...
	  exports["default"] = sortProjectData;
	  module.exports = exports["default"];
	  ...
	  (function () {
	    module.hot.dispose(function (data) {
	      ...
	      var makeExportsHot = require("/Users/vitalvu/Dropbox/code/vendor/react_examples/relato/node_modules/react-hot-loader/makeExportsHot.js"),
	        ...
	        module.hot.accept(function (err) {
	          if (err) {
	            console.error("Cannot not apply hot update to " + "sortProjectData.js" + ": " + err.message);
	          }
	        });
	      }
	    }
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/vitalvu/Dropbox/code/vendor/react_examples/relato/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "sortProjectData.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pagination = _react2["default"].createClass({
	  ...
	  render: function render() {
	    return _react2["default"].createElement("ul", { className: "pagination" }, _react2["default"].createElement("li", null, _react2["default"].createElement("a", { href: "#", onClick: this.firstPage }, "««")), _react2["default"].createElement("li", null, _react2["default"].createElement("a", { href: "#", onClick: this.previousPage }, "«")), _react2["default"].createElement("li", null, _react2["default"].createElement("a", { href: "#", onClick: this.nextPage }, "»")), _react2["default"].createElement("li", null, _react2["default"].createElement("a", { href: "#", onClick: this.lastPage }, "»»")));
	  }
	});
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/vitalvu/Dropbox/code/vendor/react_examples/relato/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Pagination.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = _react2["default"].createClass({
	  ...
	  render: function render() {
	    return _react2["default"].createElement("div", { className: "search" }, _react2["default"].createElement("label", { htmlFor: "search" }, "Search"), _react2["default"].createElement("input", { type: "search", id: "search", onChange: this.search }));
	  }
	});
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/vitalvu/Dropbox/code/vendor/react_examples/relato/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Search.jsx" + ": " + err.message); } }); } } })(); }
	...
	var DataTable = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    if (projects.length > 0) {
	      visibleProjects = projects.slice(page * pageLength, Math.min(projects.length, page * pageLength + pageLength));
	    }

	    var setSortProperty = function setSortProperty(prop, defaultOrder, e) {
	    ...
	    var sortClassName = function sortClassName(prop) {
	      var className = '';
	      if (appState.sort.property === prop) {
	    ...
	    return _react2['default'].createElement('table', null, _react2['default'].createElement('thead', null, _react2['default'].createElement('tr', null, _react2['default'].createElement('th', { href: '#', className: sortClassName('name'), onClick: setSortProperty.bind(null, 'name', true) }, 'Name'), _react2['default'].createElement('th', { href: '#', className: sortClassName('users'), onClick: setSortProperty.bind(null, 'users', false) }, 'Num Users'), _react2['default'].createElement('th', { href: '#', className: sortClassName('runtimeUsers'), onClick: setSortProperty.bind(null, 'runtimeUsers', false) }, 'Num Runtime Users'), _react2['default'].createElement('th', { href: '#', className: sortClassName('developmentUsers'), onClick: setSortProperty.bind(null, 'developmentUsers', false) }, 'Num Development Users'), _react2['default'].createElement('th', { href: '#', className: sortClassName('pageRank'), onClick: setSortProperty.bind(null, 'pageRank', false) }, 'PageRank'))), _react2['default'].createElement('tbody', null, visibleProjects.map(function (project) {
	      return _react2['default'].createElement('tr', { key: project.name }, _react2['default'].createElement('td', null, _react2['default'].createElement('a', { href: 'https://npmjs.org/package/' + project.name }, project.name)), _react2['default'].createElement('td', null, (0, _numeral2['default'])(project.runtimeUsers + project.developmentUsers).format('0,0')), _react2['default'].createElement('td', null, (0, _numeral2['default'])(project.runtimeUsers).format('0,0')), _react2['default'].createElement('td', null, (0, _numeral2['default'])(project.developmentUsers).format('0,0')), _react2['default'].createElement('td', null, (0, _numeral2['default'])(project.pageRank).format('0,0.00')));
	    })));
	  }
	});
